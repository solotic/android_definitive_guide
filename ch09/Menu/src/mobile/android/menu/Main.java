		...
		OnClickListener
{
	...
	//	addMenuItem.setOnMenuItemClickListener(this);
		...
		MenuItem menuItem3 = menu.add(1, menuItemId++, 4, "菜单3");
		MenuItem menuItem4 = menu.add(1, menuItemId++, 4, "菜单4");
	...
	{
		// 添加子菜单
		SubMenu fileSubMenu = menu.addSubMenu(1, menuItemId++, 0, "文件");
